...
const is31Flavors = (arr) => arr.length === 31 ? true : false;
...
function getRandomFlavors (arr1, arr2, arr3, arr4){
    var randomArray = [];
    let totalArray = [...arr1, ...arr2, ...arr3, ...arr4];
    // console.log(totalArray);
    while (randomArray.length < 31) {
      let random = (Math.floor(Math.random() * totalArray.length));
      randomArray.push(totalArray[random]);
      totalArray.splice(random, 1);
    }
  return randomArray;
  }
